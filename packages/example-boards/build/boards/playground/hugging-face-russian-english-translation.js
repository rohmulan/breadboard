...
const makeHeaders = code({ apiKey }, { headers: object({ Authorization: "string" }) }, ({ apiKey }) => {
    return { headers: { Authorization: `Bearer ${apiKey}` } };
});
const makePayload = code({ inputs, useCache, waitForModel }, { payload: object({ inputs: "string", options: object({ use_cache: "boolean", wait_for_model: "boolean" }) }) }, ({ inputs, useCache, waitForModel }) => {
    const request = {
        inputs: inputs,
        options: {
            use_cache: useCache,
...
//# sourceMappingURL=hugging-face-russian-english-translation.js.map