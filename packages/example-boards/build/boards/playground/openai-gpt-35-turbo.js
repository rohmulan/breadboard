...
const imagePartType = object({
    inlineData: object({
        mimeType: enumeration("image/png", "image/jpeg", "image/heic", "image/heif", "image/webp"),
        data: "string",
    }),
});
...
const partType = anyOf(textPartType, imagePartType, functionCallPartType, functionResponsePartType);
...
const functionDeclaration = object({
    name: "string",
    description: "string",
    parameters: unsafeType({ type: "object" }),
});
...
//# sourceMappingURL=openai-gpt-35-turbo.js.map