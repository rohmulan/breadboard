...
export const searchTags = input({
    type: enumeration("story", "comment", "poll", "pollopt", "show_hn", "ask_hn", "front_page"),
    title: "Tags",
...
const constructURL = code({ id: "urlContructOutput", tags: searchTags, page: pageNumber }, { url: "string" }, ({ tags, page }) => {
...
//# sourceMappingURL=hacker-news-algolia-search.js.map