 ...
 */
import { annotate, board, input, object, output, unsafeCast, } from "@breadboard-ai/build";
...
const instructions = prompt `Translate the math problem below into a self-contained,
